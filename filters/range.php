...
$filter['collapse'] = 'yes';
$filter['show_term_names'] = 'no';
// print_r($filter);
?>
<div class="wpc-filters-section wpc-filter-taxonomy wpc-filter-layout-checkboxes wpc-filter-full-height wpc-filter-collapsible wpc-filter-visible-term-names" data-fid="<?php echo esc_attr( $filter['ID'] ); ?>">
